    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Órdenes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Órdenes_Clientes_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Órdenes_Productos_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Órdenes_ClientId",
                table: "Órdenes",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Órdenes_ProductId",
                table: "Órdenes",
                column: "ProductId");
        }
